 ...
 * adminPortfolio.setCreative(admin);
 * creativeService.saveCreative(admin);
 * portfolioService.savePortfolio(adminPortfolio);
 * 
 * }
 * }
 * 
 ...
 * Portfolio moderatorPortfolio = new Portfolio();
 * 
 * Set<Profession> professions = new HashSet<Profession>();
 ...
 * moderatorPortfolio.setCreative(moderator);
 * creativeService.saveCreative(moderator);
 * portfolioService.savePortfolio(moderatorPortfolio);
 * }
 * }
 * 
 ...
 * userPortfolio.setCreative(user);
