 ...
 * newProject.setAuthor(creativeService.findCreativeByUsername(userDetails.
 * getUsername()));
 ...
 * 
 * @PreAuthorize("isAuthenticated()")
 * public ResponseEntity<Void> updateProject(@PathVariable Long id, @RequestBody
 * Project project,
 * 
 * @AuthenticationPrincipal UserDetails userDetails) {
 * if (projectService.existsById(id)) {
 * // Check if the authenticated user has the admin role or if the ID matches
 * the
 * // authenticated user
